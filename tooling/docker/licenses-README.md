...
| ------- | ------------------------------------- | ------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------- |
| base    | Node.js                               | `node-LICENSE`                             | copied from the digest-pinned `node:24.20.0-trixie-slim` image                                                                                        |
...
| base    | swig (crossbind fork)                 | `swig-LICENSE*`                            | built from crossbind/swig @ `844524ad`; only the binary ships, so the texts are copied out of the build stage                                         |
